...
Funcionalidade: Editar perfil candidato
  ...
  Cenário: Informando que o perfil é controlado por assessoria de imprensa
    Quando o candidato editar seu perfil
    E marcar 'Sim' no campo Assessoria de Imprensa
    E confirmar a alteração
    Então ele deve ver suas informações atualizadas
    E ele deve ser uma mensagem informando que seu perfil é gerenciado pela assessoria de imprensa

  Cenário: Informando que o perfil é controlado pelo Candidato
    Quando o candidato editar seu perfil
    E marcar 'Não' no campo Assessoria de Imprensa
    E confirmar a alteração
    Então ele deve ver suas informações atualizadas
